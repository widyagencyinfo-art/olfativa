...
// Google AdSense. Cuando Dario se de de alta en adsense.google.com y anada
// olfativa.es, Google le da un ID de editor con el formato "ca-pub-XXXXXXXXXXXXXXXX".
// SOLO hay que pegarlo aqui: el script, el meta de verificacion y el ads.txt se
// activan solos. Mientras este vacio, la web no carga NADA de publicidad (inerte),
// asi que no afecta al rendimiento ni al SEO.
export const ADSENSE_CLIENT = "";

// Canal Telegram para difusion diaria y viralizacion organica.
// Cada visitante SEO ve la CTA -> se suscribe -> recibe perfume del dia.
export const TELEGRAM_CHANNEL_URL = "https://t.me/olfativacomunidad";
export const TELEGRAM_CHANNEL_NAME = "Olfativa Comunidad";
export const TELEGRAM_CHANNEL_HANDLE = "@olfativacomunidad";
