...
export const LISTS = [
  ...
  },
  {
    ...
    h1: "Mejores perfumes amaderados (de madera)",
    title: "Perfumes de madera: los mejores amaderados con aroma a madera",
    description:
      "Los mejores perfumes de madera: amaderados con aroma a cedro, sándalo, vetiver y maderas exóticas. Selección con precios, notas y para qué temporada.",
    intro:
      "Los **perfumes de madera** (familia amaderada) son de los más populares y versátiles. Si buscas fragancias con **aroma a madera**, aquí van desde frescos amaderados aromáticos hasta amaderados especiados muy intensos, con cedro, sándalo y vetiver como protagonistas.",
